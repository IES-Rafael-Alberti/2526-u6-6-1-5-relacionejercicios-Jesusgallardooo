...
Comentar y documentar el código es importante porque permite que otros desarrolladores (y tú mismo en el futuro) entiendan
la lógica, el propósito y el funcionamiento del código sin tener que leer cada línea detenidamente. Facilita el mantenimiento,
la detección de errores y la colaboración en equipo.

La diferencia entre comentarios y documentación es que los comentarios son anotaciones breves dentro del código para explicar 
ciertas líneas o cierta parte del código, mientras que la documentación es la información estructurada que describe las clases, 
los métodos, los módulos... de manera más formal y detallada. 

En esta práctica por ejemplo la documentación la hemos generado con dokka, mientras que los comentarios los he escrito a mano.


b) Describe **dos ejemplos** de comentarios importantes y necesarios (según la teoría) y enlaza a tu código.

RESPUESTA:
Dos ejemplos de comentarios/documentación importantes y necesarios son:

- ejemplo 1: enlace [aquí](https://github.com/IES-Rafael-Alberti/2526-u6-6-1-5-relacionejercicios-Jesusgallardooo/blob/bc93098aeaef358842c519a97c9ba4dee740a259/src/main/kotlin/es/ies/ejercicios/u6/ej64/ProgramaDocumentable.kt#L11-L17)

- ejemplo 2: enlace [aquí](https://github.com/IES-Rafael-Alberti/2526-u6-6-1-5-relacionejercicios-Jesusgallardooo/blob/bc93098aeaef358842c519a97c9ba4dee740a259/src/main/kotlin/es/ies/ejercicios/u6/ej64/ProgramaDocumentable.kt#L3-L5)

c) Describe **dos ejemplos** de comentarios/documentación no importante o innecesaria y enlaza a tu código (antes/después).

RESPUESTA:
Los comentarios no importantes e innecesarios los eliminé al principio de la práctica por lo que no puedo enlazarlo, pero
recuerdo que los únicos comentarios que he eliminado han sido los que aclaraban cosas obvias como describiendo el valor de 
las variables o describiendo que la función hacerBocadillo() hace un bocadillo.

d) Porque la documentación se genera en el directorio `Doc/`? ¿Dónde se indica esto?

RESPUESTA:
Se genera en esta carpeta porque asi está definido en el [build.gradle.kts]()

## Enlaces permanentes a código (obligatorio)

Incluye enlaces permanentes a:

- [KDoc que hayas añadido/mejorado.](https://github.com/IES-Rafael-Alberti/2526-u6-6-1-5-relacionejercicios-Jesusgallardooo/blob/bc93098aeaef358842c519a97c9ba4dee740a259/src/main/kotlin/es/ies/ejercicios/u6/ej64/ProgramaDocumentable.kt#L104-L129)
- [Comentarios que hayas añadido porque aportan valor.](https://github.com/IES-Rafael-Alberti/2526-u6-6-1-5-relacionejercicios-Jesusgallardooo/blob/bc93098aeaef358842c519a97c9ba4dee740a259/src/main/kotlin/es/ies/ejercicios/u6/ej64/ProgramaDocumentable.kt#L120-L125)
- [Comentarios innecesarios que hayas eliminado.](https://github.com/IES-Rafael-Alberti/2526-u6-6-1-5-relacionejercicios-Jesusgallardooo/blob/bc93098aeaef358842c519a97c9ba4dee740a259/docs/ejercicios/6.4.md?plain=1#L87-L89)
